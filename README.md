...
- Automatyczne przekształcanie notatek w **fiszki** w momencie użycia znaków specjalnych (`-` lub `:`) w formacie  `pojęcie : definicja`.
...
npm start
```
5. ***Pobierz Expo Go na Android lub iOS i zeskanuj wygenerowany w poprzednim kroku kod qr***
6. ***Alternatywnie możesz pobrać gotowy plik APK z linku poniżej***
[notoo](https://drive.google.com/file/d/1G4GhLCutX0FCtBcJLSzTUYFFCyxMzG7d/view?usp=sharing)
